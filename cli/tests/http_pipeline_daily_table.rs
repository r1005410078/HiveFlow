...
fn pipeline_daily_table_renders_top_candidates_and_factor_availability() {
    ...
    assert!(table.contains("贵州茅台"));
    assert!(table.contains("名称"));
